import asyncio
from hotel.reservations import Reservation, ReservationSystem
from hotel.customers import Customer, CustomerManagement
from hotel.rooms import Room, RoomManagement
from hotel.payments import process_payment
